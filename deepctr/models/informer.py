...
from ..layers.interaction import ProbAttention, AttentionLayer
from ..layers.utils import concat_func, add_func, combined_dnn_input

from deepctr.models.pairwise import Pairwise


def Informer(dnn_feature_columns, att_layer_num=3, att_embedding_size=8, att_head_num=2,
            dnn_hidden_units=(256, 256), dnn_activation='relu', l2_reg_embedding=1e-5,
            l2_reg_dnn=0, dnn_use_bn=False, dnn_dropout=0, seed=1024, task='binary', model_mode='point'):
