...
def WDL(linear_feature_columns, dnn_feature_columns, dnn_hidden_units=(128, 128), l2_reg_linear=1e-5,
    ...
    dnn_out = DNN(dnn_hidden_units, dnn_activation, l2_reg_dnn, dnn_dropout, False, seed=seed, train_bias=use_bias)(dnn_input)
    ...
    if model_mode == 'index':
        model = tf.keras.models.Model(inputs=inputs_list, outputs=[output, dnn_out])
